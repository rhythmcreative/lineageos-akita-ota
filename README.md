...
```text
.
├── akita.json          # Default channel metadata
├── akita-stable.json   # Stable channel metadata
├── akita-beta.json     # Beta channel metadata
├── akita-alpha.json    # Alpha channel metadata
└── README.md
```
